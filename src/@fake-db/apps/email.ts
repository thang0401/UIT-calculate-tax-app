...
const data: { emails: MailType[] } = {
  emails: [
    ...
    },
    {
      ...
      bcc: [],
      message:
        '<p>Hello John, </p><p>Shipping Details:</p><p>Order Number: 82080</p><p>Delivered-to: <strong>John Doe</strong></p><p>Email: <strong>thangnc@altervista.org</strong></p><p>Address: <strong>99 El ABCD San Francisco, CA. United States </strong></p><p>Thank You for being with Us!</p><p>Regards</p><p>Shawn Wilby</p>',
      attachments: [],
      isStarred: false,
      labels: ['company'],
    ...
    },
    {
      ...
      to: [
        {
          name: 'me',
          email: 'thangnc@sciencedaily.com'
        }
      ],
    ...
    },
    {
      ...
      to: [
        {
          name: 'me',
          email: 'thangnc@odnoklassniki.ru'
        }
      ],
